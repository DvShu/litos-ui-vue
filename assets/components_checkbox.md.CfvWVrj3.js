import{d as h,e as x}from"./chunks/theme.j-P-CnI_.js";import{d as q,p,B as y,c as v,o as k,at as P,G as o,j as t,w as d,k as n,a,F as f,C}from"./chunks/framework.DUND-OMv.js";const D=JSON.parse('{"title":"Checkbox 复选框","description":"","frontmatter":{},"headers":[],"relativePath":"components/checkbox.md","filePath":"components/checkbox.md","lastUpdated":1760171877000}'),S={name:"components/checkbox.md"},I=q({...S,setup(A){const r=[["CD","成都"],["BJ","北京"],["SZ","深圳"],["HZ","杭州"]],g=p(!0),c=p(["CD","SZ"]),m=p(!1),s=p(!0);function V(b){s.value=!1,c.value=b?r.map(e=>e[0]):[]}function _(b){const e=b.length;m.value=e===r.length,e===0?s.value=!1:s.value=e<r.length}return(b,e)=>{const i=y("CodePreview"),u=y("ClientOnly");return k(),v("div",null,[e[10]||(e[10]=P('<h1 id="checkbox-复选框" tabindex="-1">Checkbox 复选框 <a class="header-anchor" href="#checkbox-复选框" aria-label="Permalink to &quot;Checkbox 复选框&quot;">​</a></h1><p>在一组备选项中进行多选。适用提醒用户勾选场景，突出多选框选项，可以有效增加用户识别度。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>单独使用可以表示两种状态之间的切换；在 <code>lv-checkbox</code> 元素中定义 <code>v-model</code> 绑定变量，单一的 <code>checkbox</code> 中，默认绑定变量的值会是 <code>Boolean</code>，选中为 <code>true</code>。</p>',5)),o(u,null,{default:d(()=>[o(i,null,{preview:d(()=>[o(n(h),{label:"Option1",modelValue:g.value,"onUpdate:modelValue":e[0]||(e[0]=l=>g.value=l)},null,8,["modelValue"])]),default:d(()=>[e[5]||(e[5]=t("textarea",{lang:"vue-html"},`  <lv-checkbox label="Option1" v-model="isCheckOption"></lv-checkbox>

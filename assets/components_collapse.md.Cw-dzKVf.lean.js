import{f as p,g as r}from"./chunks/theme.CQafP7Fx.js";import{p as v,B as m,c as b,o as f,au as u,G as a,j as l,w as t,a as d,k as i}from"./chunks/framework.B8v7S4uB.js";const w=JSON.parse('{"title":"Collapase 折叠面板","description":"","frontmatter":{},"headers":[],"relativePath":"components/collapse.md","filePath":"components/collapse.md","lastUpdated":1760171877000}'),h={name:"components/collapse.md"},C=Object.assign(h,{setup(g){v(["1"]);const s=v(["1"]);return(x,e)=>{const n=m("CodePreview"),o=m("ClientOnly");return f(),b("div",null,[e[16]||(e[16]=u("",5)),a(o,null,{default:t(()=>[a(n,null,{default:t(()=>[...e[1]||(e[1]=[l("textarea",{lang:"vue-html"},`  <lv-collapse>
  ...
  `,-1)])]),_:1})]),_:1}),e[33]||(e[33]=u("",7))])}}});export{w as __pageData,C as default};

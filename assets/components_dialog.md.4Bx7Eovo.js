import{_ as s,j as m,k as T,L as B,M as p,D as h}from"./chunks/theme.DD-_cGzL.js";import{d as y,p as c,B as P,c as q,o as V,at as x,G as d,j as o,w as e,k as i,a as l}from"./chunks/framework.BSvSrwQ3.js";const I=JSON.parse('{"title":"Dialog","description":"","frontmatter":{},"headers":[],"relativePath":"components/dialog.md","filePath":"components/dialog.md","lastUpdated":1760171877000}'),N={name:"components/dialog.md"},O=y({...N,setup(A){const g=c(!1),f=c(!1),b=c(!1),v=c(!1);function k(n,t){if(n==="ok"){const r=B.open({to:".edit-dialog",bar:!0});setTimeout(()=>{r.close(),p.success("提交成功"),t()},2e3)}else t()}function D(){h.alert("这是 Alert Content","Alert Title").then(n=>{n===!0?p.success("点击了确定"):p.info("点击了关闭")})}function w(){h.confirm("这是 Confirm Content","Confirm Title",{type:"success"}).then(n=>{n===!0?p.success("点击了确定"):p.info("点击了关闭")})}function C(){h.prompt("请输入用户名","Prompt Title").then(n=>{p.info("用户名："+n)})}return(n,t)=>{const r=P("CodePreview"),u=P("ClientOnly");return V(),q("div",null,[t[25]||(t[25]=x('<h1 id="dialog" tabindex="-1">Dialog <a class="header-anchor" href="#dialog" aria-label="Permalink to &quot;Dialog&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>需要设置 <code>model-value / v-model</code> 属性，它接收 <code>Boolean</code>，当为 <code>true</code> 时显示 <code>Dialog</code>。<code>title</code> 属性用于定义标题，它是可选的，默认值为空。</p>',5)),d(u,null,{default:e(()=>[d(r,null,{preview:e(()=>[d(i(s),{type:"primary",onClick:t[0]||(t[0]=a=>g.value=!0)},{default:e(()=>[...t[8]||(t[8]=[l("显示 Dialog",-1)])]),_:1}),d(i(m),{modelValue:g.value,"onUpdate:modelValue":t[1]||(t[1]=a=>g.value=a),title:"Title"},{default:e(()=>[...t[9]||(t[9]=[l(" 这是内容 ",-1)])]),_:1},8,["modelValue"])]),default:e(()=>[t[10]||(t[10]=o("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),t[33]||(t[33]=x('<h3 id="消息弹窗" tabindex="-1">消息弹窗 <a class="header-anchor" href="#消息弹窗" aria-label="Permalink to &quot;消息弹窗&quot;">​</a></h3><p>模拟系统的消息提示框而实现的一套模态对话框组件，用于消息提示、确认消息和提交内容。系统自带有3种消息弹窗：<code>alert</code>、<code>confirm</code>、<code>prompt</code> 但是其样式比较简陋不太美观，消息弹窗优化了样式。</p><p>分别通过 <code>NtDialogBox.alert()</code>、<code>NtDialogBox.confirm()</code>、<code>NtDialogBox.prompt()</code> 调用</p>',3)),d(u,null,{default:e(()=>[d(r,null,{preview:e(()=>[d(i(s),{onClick:D},{default:e(()=>[...t[21]||(t[21]=[l("alert",-1)])]),_:1}),d(i(s),{onClick:w},{default:e(()=>[...t[22]||(t[22]=[l("confirm",-1)])]),_:1}),d(i(s),{onClick:C},{default:e(()=>[...t[23]||(t[23]=[l("prompt",-1)])]),_:1})]),default:e(()=>[t[24]||(t[24]=o("textarea",{lang:"vue"},`  <script setup lang="ts">
    function openAlert() {

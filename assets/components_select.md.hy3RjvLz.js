import{H as c}from"./chunks/theme.CSHym8GW.js";import{p as v,B as x,c as _,o as y,at as b,G as t,j as l,w as o,k as a,a as s}from"./chunks/framework.BSvSrwQ3.js";const k=JSON.parse('{"title":"Select 选择器","description":"","frontmatter":{},"headers":[],"relativePath":"components/select.md","filePath":"components/select.md","lastUpdated":1760171877000}'),P={name:"components/select.md"},A=Object.assign(P,{setup(T){const f=["苹果","香蕉","橙子","葡萄","柠檬","草莓","樱桃","芒果","猕猴桃","杨梅","菠萝","西瓜","哈密瓜","桃子","梨","柿子","榴莲","椰子","龙眼","荔枝"],i=f.slice(0,10).map((p,e)=>({value:e,label:p})),h=v(i),r=v(""),g=v([]),u=v([]),V=v(!1);function S(p){V.value=!0,setTimeout(()=>{p?h.value=f.filter(e=>e.includes(p)).map((e,n)=>({value:n,label:e})):h.value=f.slice(0,10).map((e,n)=>({value:n,label:e})),V.value=!1},1500)}return(p,e)=>{const n=x("CodePreview"),m=x("ClientOnly");return y(),_("div",null,[e[13]||(e[13]=b('<h1 id="select-选择器" tabindex="-1">Select 选择器 <a class="header-anchor" href="#select-选择器" aria-label="Permalink to &quot;Select 选择器&quot;">​</a></h1><p>下拉选择器</p><ul><li>弹出一个下拉菜单给用户选择操作，用于代替原生的选择器，或者需要一个更优雅的多选器</li><li>当选项过多时，使用下拉菜单展示并选择内容</li></ul><blockquote><p><code>Select</code> 的默认宽度更改为 <code>100%</code> 当使用内联形式时，宽度将显示异常。为了保持显示正常, 您需要手动配置 <code>Select</code> 的宽度</p></blockquote><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h3><p>基础用法</p>',7)),t(m,null,{default:o(()=>[t(n,null,{preview:o(()=>[t(a(c),{options:a(i),modelValue:r.value,"onUpdate:modelValue":e[0]||(e[0]=d=>r.value=d),style:{width:"180px"}},null,8,["options","modelValue"])]),default:o(()=>[e[8]||(e[8]=l("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),e[19]||(e[19]=b('<h3 id="远程搜索" tabindex="-1">远程搜索 <a class="header-anchor" href="#远程搜索" aria-label="Permalink to &quot;远程搜索&quot;">​</a></h3><p>搜索框和远程数据结合，输入关键字以从远程服务器中查找数据。</p><p>为了启用远程搜索，需要将 <code>filterable</code> 和 <code>remote</code> 同时设置为 <code>true</code>，同时监听 <code>on-search</code> 事件，事件参数为输入的值, 可以在事件中搜索远程结果，并重新更新 <code>options</code> 选项 。</p>',3)),t(m,null,{default:o(()=>[t(n,null,{preview:o(()=>[t(a(c),{options:h.value,modelValue:r.value,"onUpdate:modelValue":e[7]||(e[7]=d=>r.value=d),style:{width:"180px"},filterable:"",remote:"",onSearch:S,loading:V.value},null,8,["options","modelValue","loading"])]),default:o(()=>[e[12]||(e[12]=l("textarea",{lang:"vue"},`  <script setup lang="ts">
    const fruits = ["苹果", "香蕉", "橙子", "葡萄", "柠檬", "草莓", "樱桃", "芒果", "猕猴桃", "杨梅", "菠萝", "西瓜", "哈密瓜", "桃子", "梨", "柿子", "榴莲", "椰子", "龙眼", "荔枝"];
    const options = fruits.slice(0, 10).map((item, i) => { return { value: i, label: item } });
    //-

import{q as u}from"./chunks/theme.CQafP7Fx.js";import{d as P,p as i,B as f,c as g,o as x,au as s,G as t,j as a,w as l,a as o,k as p}from"./chunks/framework.B8v7S4uB.js";const N=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1760171877000}'),V={name:"components/input.md"},C=P({...V,setup(I){const m=i(""),c=i(""),h=i(""),v=i("");function _(b){let e=parseInt(b,10);return Number.isNaN(e)?e="":e=Math.abs(e),String(e)}return(b,e)=>{const n=f("CodePreview"),r=f("ClientOnly");return x(),g("div",null,[e[8]||(e[8]=s('<h1 id="input-输入框" tabindex="-1">Input 输入框 <a class="header-anchor" href="#input-输入框" aria-label="Permalink to &quot;Input 输入框&quot;">​</a></h1><p>通过鼠标或键盘输入内容，是最基础的表单域的包装。</p><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2><h3 id="基本使用" tabindex="-1">基本使用 <a class="header-anchor" href="#基本使用" aria-label="Permalink to &quot;基本使用&quot;">​</a></h3><p>文本输入的基础用法。</p>',5)),t(r,null,{default:l(()=>[t(n,null,{default:l(()=>[...e[4]||(e[4]=[a("textarea",{lang:"vue-html"},`<lv-input placeholder="请输入内容"></lv-input>

...
import{p as k,q as v,v as E,V as c,B as u,c as _,o as y,at as h,G as e,j as l,w as a,k as i,a as o}from"./chunks/framework.BSvSrwQ3.js";import{Z as f,$ as T,a0 as C,a1 as F,p as A,q as d,a2 as w,K as B,J as D,a3 as P,a4 as q}from"./chunks/theme.DD-_cGzL.js";const j=JSON.parse('{"title":"Theme 主题切换","description":"","frontmatter":{},"headers":[],"relativePath":"components/theme.md","filePath":"components/theme.md","lastUpdated":1760171877000}'),x={name:"components/theme.md"},S=Object.assign(x,{setup(V){const t=k(""),m=k("");v(t,n=>{c(()=>import("./chunks/theme.DD-_cGzL.js").then(s=>s.aA),__vite__mapDeps([0,1])).then(s=>s.applyTheme(n))}),E(()=>{c(()=>import("./chunks/theme.DD-_cGzL.js").then(n=>n.aA),__vite__mapDeps([0,1])).then(n=>{t.value=n.getTheme()})});function b(){const n=document.getElementById("color-theme-style");if(n!=null){let s=n.innerHTML;s=s.replace("{",` {\r
  `).replaceAll(";",`;\r
  `).replace("  }","}"),m.value=s}}return(n,s)=>{const r=u("CodePreview"),p=u("ClientOnly");return y(),_("div",null,[s[5]||(s[5]=h(`<h1 id="theme-主题切换" tabindex="-1">Theme 主题切换 <a class="header-anchor" href="#theme-主题切换" aria-label="Permalink to &quot;Theme 主题切换&quot;">​</a></h1><p>通过切换主题来减轻长时间使用屏幕带来的视觉疲劳</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><blockquote><ol><li>主题切换是通过 <a href="https://www.npmjs.com/package/ph-utils" target="_blank" rel="noreferrer">ph-utils</a> 工具库的 <code>theme</code> 工具类控制</li><li>为了每次切换主题后，重新加载能够生效，需要在应用开始的时候, 执行 <code>initTheme()</code> 方法</li></ol></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-brgpg" id="tab-OIzeC8o" checked><label data-title="main.ts" for="tab-OIzeC8o">main.ts</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { initTheme } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;ph-utils/theme&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>

import{F as h,N as b,O as w}from"./chunks/theme.DrcBp2Zx.js";import{p as v,B as u,c as f,o as s,at as p,G as d,j as e,w as a,k as r,a as o,b as m}from"./chunks/framework.DUND-OMv.js";const V=JSON.parse('{"title":"Switch 开关","description":"","frontmatter":{},"headers":[],"relativePath":"components/switch.md","filePath":"components/switch.md","lastUpdated":1760171877000}'),x={name:"components/switch.md"},q=Object.assign(x,{setup(k){const n=v(!0);return(_,t)=>{const i=u("CodePreview"),c=u("ClientOnly");return s(),f("div",null,[t[6]||(t[6]=p("",5)),d(c,null,{default:a(()=>[d(i,null,{preview:a(()=>[d(r(h),{modelValue:n.value,"onUpdate:modelValue":t[0]||(t[0]=l=>n.value=l)},null,8,["modelValue"])]),default:a(()=>[t[3]||(t[3]=e("textarea",{lang:"vue"},`  <script setup>
    import { ref } from 'vue';
    const open = ref(true);
  <\/script>
  <template>

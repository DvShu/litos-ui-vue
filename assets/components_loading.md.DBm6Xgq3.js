import{L as o,_ as c}from"./chunks/theme.DD-_cGzL.js";import{p as g,B as E,c as r,o as p,at as b,G as s,j as a,w as e,a5 as h,a as t,k as i}from"./chunks/framework.BSvSrwQ3.js";const F={class:"loading-demo"},x={class:"loading-demo","nt-loading-text":"loading……","nt-loading-background":"rgba(255, 255, 255, .9)"},T={class:"loading-demo"},I=JSON.parse('{"title":"Loading 加载","description":"","frontmatter":{},"headers":[],"relativePath":"components/loading.md","filePath":"components/loading.md","lastUpdated":1760171877000}'),A={name:"components/loading.md"},q=Object.assign(A,{setup(L){const v=g(!0),u=g(!1);function f(){u.value=!0,setTimeout(()=>{u.value=!1},3e3)}const k=g(!1);function y(){k.value=!0}function C(){k.value=!1}let m;function _(){m=o.open(),setTimeout(()=>{m.close()},3e3)}return(P,n)=>{const l=E("CodePreview"),d=E("ClientOnly");return p(),r("div",null,[n[11]||(n[11]=b('<h1 id="loading-加载" tabindex="-1">Loading 加载 <a class="header-anchor" href="#loading-加载" aria-label="Permalink to &quot;Loading 加载&quot;">​</a></h1><p>数据加载时显示的动效。</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="区域加载" tabindex="-1">区域加载 <a class="header-anchor" href="#区域加载" aria-label="Permalink to &quot;区域加载&quot;">​</a></h3><p>在某一个区域加载数据时展示加载动画，防止页面失去响应，提高用户体验</p>',5)),s(d,null,{default:e(()=>[s(l,null,{preview:e(()=>[h((p(),r("div",F,[...n[0]||(n[0]=[t(" 内容加载区域 ",-1)])])),[[i(o),v.value]])]),default:e(()=>[n[1]||(n[1]=a("textarea",{lang:"vue-html"},`  <div class="loading-demo" v-loading="loading">
    内容加载区域
  </div>

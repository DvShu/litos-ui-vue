const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/theme.j-P-CnI_.js","assets/chunks/framework.DUND-OMv.js"])))=>i.map(i=>d[i]);
import{p as k,q as v,v as E,V as u,B as c,c as _,o as y,at as h,G as e,j as l,w as a,k as i,a as o}from"./chunks/framework.DUND-OMv.js";import{a0 as f,a1 as T,a2 as C,a3 as F,r as A,s as d,a4 as D,O as P,N as w,a5 as B,a6 as x}from"./chunks/theme.j-P-CnI_.js";const S=JSON.parse('{"title":"Theme 主题切换","description":"","frontmatter":{},"headers":[],"relativePath":"components/theme.md","filePath":"components/theme.md","lastUpdated":1760171877000}'),V={name:"components/theme.md"},I=Object.assign(V,{setup(q){const t=k(""),m=k("");v(t,n=>{u(()=>import("./chunks/theme.j-P-CnI_.js").then(s=>s.aD),__vite__mapDeps([0,1])).then(s=>s.applyTheme(n))}),E(()=>{u(()=>import("./chunks/theme.j-P-CnI_.js").then(n=>n.aD),__vite__mapDeps([0,1])).then(n=>{t.value=n.getTheme()})});function b(){const n=document.getElementById("color-theme-style");if(n!=null){let s=n.innerHTML;s=s.replace("{",` {\r
  `).replaceAll(";",`;\r
  `).replace("  }","}"),m.value=s}}return(n,s)=>{const r=c("CodePreview"),p=c("ClientOnly");return y(),_("div",null,[s[5]||(s[5]=h(`<h1 id="theme-主题切换" tabindex="-1">Theme 主题切换 <a class="header-anchor" href="#theme-主题切换" aria-label="Permalink to &quot;Theme 主题切换&quot;">​</a></h1><p>通过切换主题来减轻长时间使用屏幕带来的视觉疲劳</p><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><blockquote><ol><li>主题切换是通过 <a href="https://www.npmjs.com/package/ph-utils" target="_blank" rel="noreferrer">ph-utils</a> 工具库的 <code>theme</code> 工具类控制</li><li>为了每次切换主题后，重新加载能够生效，需要在应用开始的时候, 执行 <code>initTheme()</code> 方法</li></ol></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-L9ooN" id="tab-j6kuOPk" checked><label data-title="main.ts" for="tab-j6kuOPk">main.ts</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { initTheme } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;ph-utils/theme&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">initTheme</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">then</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="自定义风格" tabindex="-1">自定义风格 <a class="header-anchor" href="#自定义风格" aria-label="Permalink to &quot;自定义风格&quot;">​</a></h3><p>框架内置的主题切换其实就是一个排版的样式，核心的主题切换的逻辑是调用的 <code>ph-utils</code> 库的 <code>theme</code> 模块相关函数来实现的。</p><p>通常调用的模块有: <code>getTheme()</code>、<code>applyTheme()</code></p><p>所以完全可以自定义按钮来实现主题切换, 下面就使用 <code>RadioGroup + Icon</code> 来实现。</p>`,6)),e(p,null,{default:a(()=>[e(r,null,{preview:a(()=>[e(i(A),{modelValue:t.value,"onUpdate:modelValue":s[0]||(s[0]=g=>t.value=g)},{default:a(()=>[e(i(d),{value:"auto",type:"button"},{default:a(()=>[e(i(D))]),_:1}),e(i(d),{value:"light",type:"button"},{default:a(()=>[e(i(P))]),_:1}),e(i(d),{value:"dark",type:"button"},{default:a(()=>[e(i(w))]),_:1})]),_:1},8,["modelValue"])]),default:a(()=>[s[2]||(s[2]=l("textarea",{lang:"vue"},`  <script setup lang="ts">
  ...
  `,-1))]),_:1})]),_:1}),s[7]||(s[7]=l("h3",{id:"更改主题色",tabindex:"-1"},[o("更改主题色 "),l("a",{class:"header-anchor",href:"#更改主题色","aria-label":'Permalink to "更改主题色"'},"​")],-1)),s[8]||(s[8]=l("p",null,[o("除了修改主题风格，还可以修改主题色，通过修改 "),l("code",null,"ThemeColor"),o(" 来实现。")],-1)),e(p,null,{default:a(()=>[e(r,null,{preview:a(()=>[e(i(B),{onChange:b})]),default:a(()=>[s[3]||(s[3]=l("textarea",{lang:"vue-html"},`  <lv-theme-color></lv-theme-color>
  `,-1))]),_:1})]),_:1}),s[9]||(s[9]=l("p",null,"生成的主题色代码如下:",-1)),e(p,null,{default:a(()=>[e(x,{"source-code":m.value},{default:a(()=>[...s[4]||(s[4]=[l("textarea",{lang:"css"},`:root {
